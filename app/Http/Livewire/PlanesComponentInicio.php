...
class PlanesComponentInicio extends Component

{
    ...
    public function mount($selectedMuni, $selectedPlane, $selectedCategoria, $precio, $dias, 
                    $localidad, $nombre, $edad, $telefono_publicacion, $whatsapp)
    {
        $this->nombre = $nombre;
        $this->edad = $edad;
        $this->precio = $precio;        
        $this->dias = $dias;
        $this->telefono_publicacion = $telefono_publicacion;
    ...
    public function render()
    {
        ...
        return view('livewire.planes-component-inicio', compact('tags_in', 'tags_etc', 'tags_ec', 'tags_al'));
    }
