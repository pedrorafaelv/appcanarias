...
<body class="antialiased">
    ...
    {{-- <div class="navbar bg-base-200 sticky top-0 z-50 shadow-sm">
        ...
        <nav class=" sticky top-0 z-50 px-4 py-4 flex justify-between items-center bg-white">
            ...
            {{-- {{Route::has('login') ? 'logueado' : 'no esta logueado'}} --}}
            {{auth()->check()}}
            ...
            <a class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200" href="{{ route('login') }}" >Ingresar</a>            @auth
            @if (Route::has('login'))
