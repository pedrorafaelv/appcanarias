                                            ...
                                            <td>
                                                <form action="{{ route('categorias.destroy',$categoria) }}" method="POST">
                                                  ...
                                                  @can('admin.categorias.show')
                                                     <a class="btn btn-sm btn-primary " href="{{ route('categorias.show',$categoria) }}"><i class="fa fa-fw fa-eye"></i> {{__('Show')}}</a>
                                                    @endcan
                                                    @can('admin.categorias.edit')
                                                    <a class="btn btn-sm btn-success" href="{{ route('categorias.edit',$categoria) }}"><i class="fa fa-fw fa-edit"></i> {{__('Edit')}}</a>
                                                    @endcan
