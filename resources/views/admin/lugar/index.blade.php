                                ...
                                <tbody>
                                    @foreach ($lugars as $lugar)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('lugars.destroy', $lugar) }}" method="POST">
                                                   @can('admin.lugares.show')                                                     
                                                     <a class="btn btn-sm btn-primary " href="{{ route('lugars.show', $lugar) }}"><i class="fa fa-fw fa-eye"></i>{{__('Show')}}</a>
                                                    @endcan
                                                    @can('admin.lugares.edit')
                                                    <a class="btn btn-sm btn-success" href="{{ route('lugars.edit', $lugar) }}"><i class="fa fa-fw fa-edit"></i>{{__('Edit')}} </a>
                                                    @endcan
                                                    @can('admin.lugares.destroy')
                                                    @csrf
                                                    @method('DELETE')
        ...
        $('#lugares').DataTable({
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    buttons: [{
                            extend: 'pdfHtml5',
                            title: 'Listado de Lugares de Atención',
                            exportOptions: {
                                columns: ':visible'
                            }
