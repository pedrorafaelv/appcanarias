                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('clases.destroy',$clase) }}" method="POST">
                                                    @can('admin.clases.show')
                                                     <a class="btn btn-sm btn-primary " href="{{ route('clases.show',$clase) }}"><i class="fa fa-fw fa-eye"></i> {{__('Show')}}</a>
                                                    @endcan
                                                    @can('admin.clases.edit')
                                                    <a class="btn btn-sm btn-success" href="{{ route('clases.edit',$clase) }}"><i class="fa fa-fw fa-edit"></i> {{__('Edit')}}</a>
                                                    @endcan
