                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('provincias.destroy',$provincia) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('provincias.show',$provincia) }}"><i class="fa fa-fw fa-eye"></i> {{__('Show')}}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('provincias.edit',$provincia) }}"><i class="fa fa-fw fa-edit"></i> {{__('Edit')}}</a>
                                                    @csrf
                                                    @method('DELETE')
