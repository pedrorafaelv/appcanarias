<div>
    ...
    <p class="my-4">
        ...
        <p class="my-4">
            ...
            {!! Form::label('provincia_id', 'Provinc') !!}
    ...
    <div class="grid grid-cols-2 gap-4">
            ...
            <div class="mt-2">
    <label for="todo_el_dia" class="block text-sm font-medium text-gray-700 mb-1">
        Todo el día
    </label>
    ...
    <input type="text" 
           id="todo_el_dia" 
           name="todo_el_dia" 
           value="{{ old('todo_el_dia', $anuncio->todo_el_dia) }}"
           wire:model="todo_el_dia"
           x-on:change="recordar_cambios()"
           placeholder="Ingrese su Tarifa para todo el día"
           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('todo_el_dia') border-red-500 @enderror">
