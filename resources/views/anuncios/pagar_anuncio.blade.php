    ...
    <div class="container my-24 px-6 mx-auto">
        ...
        <section class="mb-32 text-gray-800">
                ...
                <div class="grid lg:grid-cols-2 flex items-center">
                    <div class="mb-12 lg:mb-0">
                        <div class="block rounded-lg shadow-lg px-6 py-12 md:px-12 lg:-mr-14"
                            ...
                            <h2 class="text-4xl font-extrabold mb-6 pb-2 text-purple-900">{{ $anuncio->plane->nombre }}
                            </h2>
           ...
           <span class="badge badge-md ">{{ $anuncio->titulo}}</span>
                            ...
                            @if (is_null($anuncio->precio) or $anuncio->precio <= 0)
                                <a class="mt-10 mb-10 px-12 py-3 text-lg font-medium text-white bg-pink-600 border border-pink-600 rounded sm:w-auto active:text-opacity-75 hover:bg-transparent hover:text-pink-700 focus:outline-none focus:ring"
                                    href="{{ route('registrar_gratis', $anuncio) }}">
                                ...
                                <script>
                                    paypal.Buttons({
                                        ...
                                        onApprove: function(data, actions) {
                                            return fetch("{{ config('app.url') }}/paypal/process/" + data.orderID +
                                        ...
                                        onError: function(err) {
                                            ...
                                            alert('Parece que PayPal esta teniendo problemas y no está disponible')
                                        }
                    ...
                    <div>
                        <img src="{{ config('app.url') }}/img/card-pagar.jpeg" class="w-full rounded-lg shadow-lg"
                            alt="" />
                    </div>
                </div>
            </div>
